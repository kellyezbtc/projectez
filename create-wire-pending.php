                                    ...
                                    <div>
                                        <table cellpadding="5" cellspacing="1" width="100%">
                                            ...
                                            <tr>
											    ...
											    <p>
											      <?php 
$sqs="select * from wires_send_tb,wires_tb,user_tb where wires_tb.bank_id=wires_send_tb.wb_id and wires_send_tb.wsu_id=user_tb.us_id and wires_send_tb.w_status=0 ORDER BY wires_tb.ben_name asc";
...
{												
											    ...
											    <table width="800" border="1" align="center" cellpadding="2" cellspacing="2" bordercolor="#e6e6e6">
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td width="64" align="center"><strong>Posted Date</strong></td>
  ...
  ?>
                                                  <tr>
													...
													{?>
                                                      <a href="create-wire-pending.php?act=1&id=<?php echo $rwc['ws_id'];?>"> MARK PAID</a>
                                                      <?php
													} ?></td>
                                                    ...
                                                    <td height="30" align="center"><a href="create-wire-pending.php?delid=<?php echo $rwc['ws_id'];?>">Delete</a></td>
                                                  </tr>
                                                  <?php 
  }
  ?>
