 ...
 require_once('conn.php');
  ...
  if(isset($_REQUEST['Submit']))
  {
	 ...
	 // header('location:create-cheque-pending.php');
	  header('location:add_cheque_send.php?act=done');
  }
                ...
                <td align="center">
					...
					<?php 
													...
													?>
											          ...
											          <tr>
											            <td width="134" height="30">SELECT CHEQUE PROFILE</td>
											            <td width="396" height="30"><select name="chh_id" id="chh_id" required>
								...
								{
								?>
                                <option value="<?php echo $rwr['ch_id']; ?>" <?php if($rwr['ch_id']==$_REQUEST['id']){?> selected<?php } ?>><?php echo $rwr['username']; ?>---<?php echo $rwr['f_name']; ?>&nbsp;<?php echo $rwr['l_name']; ?> [<?php echo $rwr['ch_bankname'];?> (<?php echo $rwr['ch_tran'];?>-<?php echo $rwr['ch_inst'];?>-<?php echo $rwr['ch_account'];?>)]</option>
                                <?php 
								}
								?>	                </select></td>
										              </tr>
											          <tr>
											            ...
											            <td height="30"><input name="c_amount" type="text" id="c_amount" size="50"></td>
										              </tr>
											          <tr>
